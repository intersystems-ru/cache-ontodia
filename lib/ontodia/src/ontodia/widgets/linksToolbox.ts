...
export class LinkInToolBox extends Backbone.View<FatLinkType> {
    ...
    public render(): LinkInToolBox {
        ...
        this.$filterButton = $('<a class="filter-button"><img src="' +
                require('../../../images/add-to-filter.png') + '"/></a>').click(() => {
...
export class LinkTypesToolbox extends Backbone.View<LinkTypesToolboxModel> {
    ...
    constructor(options: LinkTypesToolboxOptions) {
        ...
        this.listenTo(this.view, 'change:elementWithHalo', (view: DiagramView, element: Element) => {
            // create delay to prevent excessive updates of toolbox when
            ...
            setTimeout(() => { this.model.set('selectedElement', this.view.getElementWithHalo()); }, 50);
        });
    ...
    public render(): LinkTypesToolbox {
        ...
        _.each(this.model.links, (link: FatLinkType) => {
